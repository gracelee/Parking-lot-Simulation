...
public class ExpressParkingLotTest {
	private ExpressParkingLot testExpressParkingLot;
	...
	public void testEconoParkingLot() {
		...
		int testInt = 2;
		testExpressParkingLot = new ExpressParkingLot(testName,testInt);
		assertEquals(testInt, testExpressParkingLot.capacity());
