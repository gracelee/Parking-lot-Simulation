...
public class LongStayParkingLotTest {
	private LongStayParkingLot testLongStayParkingLot;
	...
	public void testEconoParkingLot() {
		...
		int testInt = 2;
		testLongStayParkingLot = new LongStayParkingLot(testName,testInt);
		assertEquals(testInt, testLongStayParkingLot.capacity());
